...
#------------------------------------------------------------------------------------
#
# FILE:         Vastra_Gotaland_Estimate_Variable_Infectivity
...
#                       The main focus of this script is the region of Vastra Gotaland, 
...
# Look at the estimated reported cases and fitted
#bottom, left, top, right c(5.1, 4.1, 4.1, 2.1)
par(mfrow = c(1,1), mar = c(6.1, 4.5, 4.1, 14.1)) # 
